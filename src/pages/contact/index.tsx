    ...
    return (
        <>
            ...
            <div className="flex flex-col h-[160px] w-[80%] items-center justify-center rounded-3xl bg-black shadow-xl lg:w-[50%]">
                ...
                <p className="text-xl text-primary py-1">email</p>
                <p className="text-xl text-[#D1D5DB] md:text-2xl">danielolatinsu@gmail.com</p>
            </div>
            <div className="flex flex-col h-[160px] w-[80%] items-center justify-center rounded-3xl bg-black shadow-xl lg:w-[50%]">
                <i className="fa-solid fa-location-dot fa-2x"></i>
                <p className="text-xl text-primary py-1">location</p>
            ...
            <div className="card max-h-fit w-full shrink-0 bg-[#101010] shadow-2xl md:max-w-2xl">
                ...
                <input
                    type="text"
                    className="input input-bordered border-none bg-black placeholder:text-[#D1D5DB]"
                    required
                />
                </div>
                <div className="form-control w-full">
                ...
                <textarea
                className="textarea textarea-bordered textarea-md w-full max-w-full border-none bg-black placeholder:text-[#D1D5DB]"
                ></textarea>
                </div>
