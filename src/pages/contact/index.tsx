    ...
    return (
        ...
        >
            {loading ? (
                ...
                <div id="contact" className={`contact-page ${text} ${background}  relative -top-[100vh] h-[calc(100vh+700px)] px-2  py-20 text-center   md:px-10 lg:py-0`}>
                    <div className="hero sticky top-[calc(100vh-700px)] flex  h-[700px] flex-col items-center justify-center pt-44   md:pt-24 lg:flex-row lg:items-start lg:justify-between lg:pb-20 lg:pt-32">
                        <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className="lg:w-1/2 lg:pr-10">
                            <h1 id="#big" className="formula_condensed mb-3 text-7xl font-bold uppercase md:text-9xl">
                                Get In Touch
                            </h1>
