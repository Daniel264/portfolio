...
import { CSSIcon, ExpressIcon, GitHubIcon, HtmlIcon, JavaScriptIcon, NextIcon, ReactIcon, SASSIcon, TypeScriptIcon, ViteTestIcon } from "./Icons";
...
const iconMap: { [key: string]: React.FC } = {
    ...
    SASS: SASSIcon,
    HTML: HtmlIcon,
    CSS: CSSIcon, // Add other icons here
