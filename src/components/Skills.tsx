...
const Skills = () => {
    return (
        <main className="flex h-full w-full flex-col items-center pb-14 text-white">
            <Reveal>
                <div>
                    <h1 className="beni_regular pb-5 text-center">STACK</h1>
                    <p className="pb-5">LANGUAGES I USE - DEV ARSENAL</p>
                </div>
            </Reveal>
            <section className="md:grid-cols- relative z-10 grid w-full grid-cols-1 justify-center gap-10 lg:w-1/2">
